...
public class UserDao {
    ...
    public static void add(User user) throws SQLException {
        PreparedStatement preparedStatementInsertIntoCarOwner = UsedCarsTradeDB.getConnection ().prepareStatement(UserQueries.INSERT_INTO_CAR_OWNER, Statement.RETURN_GENERATED_KEYS);
