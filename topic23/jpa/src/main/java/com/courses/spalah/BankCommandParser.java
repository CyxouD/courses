...
import com.courses.spalah.service.BankAccountControlService;
...
public class BankCommandParser {
    ...
    private void processAddCommand(String[] commandUnits) throws NoSuchCommandException, WrongNumberOfParameters {
        ...
        if (additionalCommand.equals("-client")) {
            ...
            bankAccountControlService.addClient(client);
            return;
    ...
    private Account processAddAccountCommand(String[] commandUnits, int commandParamsNumber) {
        ...
        Account account = bankCommandProcessor.formAccountToAdd(clientInn, accountBalance);
        return account;
    }

    private Transaction processAddTransactionCommand(String[] commandUnits) {
        Transaction transaction = bankCommandProcessor.formTransactionToAdd(commandUnits[IndexCommandCorrespondence.FIRST_PARAM.getIndex()], commandUnits[IndexCommandCorrespondence.SECOND_PARAM.getIndex()]);
        return transaction;
    }
